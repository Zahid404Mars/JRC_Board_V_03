...
function Battery_Log_fun(label, data, ctx12) {
    new Chart(ctx12, {
        type: 'line',
        data: {
            datasets: [{
                data: data,
                lineTension: 0.3,
                backgroundColor: "#16c46d",
                borderColor: "black",
                pointRadius: 5,
                pointBackgroundColor: "#16c46d",
                pointBorderColor: "black",
                pointHoverRadius: 3,
                pointHoverBackgroundColor: "#16c46d",
...
function PH_Log_fun(label, data, ctx8) {
    new Chart(ctx8, {
        type: 'line',
        data: {
            datasets: [{
                ...
                borderColor: "black",
                pointRadius: 5,
                pointBackgroundColor: "#98F5F9",
                pointBorderColor: "black",
                pointHoverRadius: 3,
                pointHoverBackgroundColor: "#98F5F9",
                pointHoverBorderColor: "black",
                pointHitRadius: 10,
                pointBorderWidth: 2,
            }],
...
function airAlt_Log_fun(label, data, ctx9) {
    new Chart(ctx9, {
        type: 'line',
        data: {
            datasets: [{
                ...
                pointBorderColor: "black",
                pointHoverRadius: 3,
                pointHoverBackgroundColor: "#CC6CE7",
                pointHoverBorderColor: "black",
                pointHitRadius: 10,
                pointBorderWidth: 2,
            }],
...
function airP_Log_fun(label, data, ctx10) {
    new Chart(ctx10, {
        type: 'line',
        data: {
            datasets: [{
                data: data,
                lineTension: 0.3,
                backgroundColor: "#6CE974",
                borderColor: "black",
                pointRadius: 5,
                pointBackgroundColor: "#6CE974",
                pointBorderColor: "black",
                pointHoverRadius: 3,
                pointHoverBackgroundColor: "#6CE974",
                pointHoverBorderColor: "black",
                pointHitRadius: 10,
                pointBorderWidth: 2,
            }],
...
function airTemp_Log_fun(label, data, ctx11) {
    new Chart(ctx11, {
        type: 'line',
        data: {
            datasets: [{
                data: data,
                lineTension: 0.3,
                backgroundColor: "#E9A66C",
                borderColor: "black",
                pointRadius: 5,
                pointBackgroundColor: "#E9A66C",
                pointBorderColor: "black",
                pointHoverRadius: 3,
                pointHoverBackgroundColor: "#E9A66C",
                pointHoverBorderColor: "black",
                pointHitRadius: 10,
                pointBorderWidth: 2,
            }],
...
var salinity_tab = document.getElementById("salinity_tab")
var PH_tab = document.getElementById("PH_tab")
var airAlt_tab = document.getElementById("airAlt_tab")
var airP_tab = document.getElementById("airP_tab")
var airTemp_tab = document.getElementById("airTemp_tab")
...
function total_fun(label,data0, data1, data2, data3, data4, data5, data6,data7,data8,data9,data10, ctx7) {
    new Chart(ctx7, {
        type: 'line',
        data: {
            labels: label,
            datasets: [ 
                ...
                },
                {
                    data: data6,
                    label: "mg/kg",
                    backgroundColor: "rgba(6, 216, 34, 0.3)",
                    borderColor: "black",
                },
                {
                    data: data7,
